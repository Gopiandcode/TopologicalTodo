...
import uk.gopiandcode.directedtodo.view.TaskListView;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager()
                .beginTransaction()
                .add(R.id.directed_todo_container, new TaskListView())
                .commit();

//        mHelper = new TaskDbHelper(this);
//        mTaskListView = (ListView) findViewById(R.id.main_todo_list);
//        updateUI();
